...
export default function PickupSlotPicker({
  ...
  if (loading) {
    return (
      <div className="rounded-xl border border-brand/10 p-4 bg-brand/5">
        <p className="text-sm text-black/60">Loading pickup times…</p>
      </div>
    );
  }
  ...
  return (
    <div className="rounded-xl border border-brand/10 p-4 bg-brand/5 space-y-4">
      ...
      <div>
        <p className="text-sm font-medium text-black mb-1">Choose pickup date &amp; time</p>
        <p className="text-xs text-black/50 mb-3">Malaysia time (MYT)</p>
        ...
        <div className="grid grid-cols-7 gap-1 text-center text-xs text-black/50 mb-1">
      ...
      {selectedDate && (
        <div>
          <p className="text-xs font-medium text-black/70 mb-2">Available times</p>
          {dateSlots.length === 0 ? (
            <p className="text-xs text-black/50">No times on this date.</p>
          ) : (
      ...
      {value && (
        <p className="text-sm text-black/70 pt-2 border-t border-brand/10">
