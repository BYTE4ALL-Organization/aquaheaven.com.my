...
export async function sendOrderConfirmationEmail(params: {
  ...
  const pickupAtLabel = params.pickupAt
    ? params.pickupAt.toLocaleString("en-MY", {
  ...
  return sendSmtpEmail({
    to: params.to,
    subject: `Order confirmation ${params.orderNumber} – Aquaheaven`,
...
export async function sendPaymentFailedEmail(params: {
  ...
  return sendSmtpEmail({
    to: params.to,
    subject: `Payment not received – order ${params.orderNumber} – Aquaheaven`,
...
export async function sendPickupReminderEmail(params: {
  ...
  return sendSmtpEmail({
    to: params.to,
    subject: `Pickup reminder – order ${params.orderNumber} – Aquaheaven`,
