...
const FAQ_BY_CATEGORY: Record<CategoryKey, FaqItem[]> = {
  towel: [
    ...
    { question: "What is your return policy for towels?", answer: "Please refer to our general return policy. Unused items in original packaging may be returned within the specified window." },
  ],
  shampoo: [
    { question: "What hair types is this shampoo suitable for?", answer: "This shampoo is formulated to suit a range of hair types. Check the product description for specific recommendations (e.g. normal, oily, dry, or color-treated hair)." },
    ...
    { question: "Is this shampoo sulfate-free?", answer: "Formula details are listed in the product description. We offer options for different preferences and scalp needs." },
    { question: "Does it work with color-treated hair?", answer: "Many of our shampoos are gentle enough for color-treated hair. See the product details for specific claims." },
    { question: "What is your return policy?", answer: "Unopened products in original packaging may be returned within our standard return window. Please see our returns page for full details." },
  ],
  conditioner: [
    { question: "What hair types is this conditioner for?", answer: "This conditioner is designed to work with a variety of hair types. Check the product description for the best match (e.g. fine, thick, or damaged hair)." },
    ...
    { question: "Is it suitable for fine or oily hair?", answer: "Many of our conditioners are lightweight and won’t weigh hair down. See the product description for specific recommendations." },
    { question: "What is your return policy?", answer: "Unopened items in original packaging may be returned within our standard return period. See our returns page for details." },
  ],
  "body-wash": [
    ...
    { question: "What is your return policy?", answer: "Unopened products may be returned within our standard return window. See our returns page for full details." },
  ],
  soap: [
    ...
    { question: "How should I store the soap?", answer: "Keep the bar in a dry soap dish between uses so it lasts longer and doesn’t become mushy." },
    { question: "Is it suitable for face and body?", answer: "Many of our soaps are gentle enough for face and body. Check the product details for specific use recommendations." },
    ...
    { question: "What is your return policy?", answer: "Unopened products in original packaging may be returned within our standard return period. See our returns page for details." },
  ],
  default: [
    ...
    { question: "What is your return policy?", answer: "Unopened items in original packaging may be returned within our return window. Please see our returns page for full conditions." },
  ],
};
